...
if(isset($_POST))
{
	...
	$DestinationDirectory	= "uploads/$hashedUserID/Business/$hashedBusinessID/"; //specify upload directory ends with / (slash)
	...
	$timeUploded = time();
	$fileName = "davao_"."u".$userID."b".$businessID."_webgate_".$timeUploded.".".$ImageExt;
	...
	if(resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType))
	{
		...
		*/
		echo "<div style = \"margin-top: 20px;\"class = \"alert alert-success\">Congratulations! Your business logo successfully uploaded!</div>";
