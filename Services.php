...
<?php //$session->confirm_logged_in_index(); ?>
    <?php 
		if(isset($_GET['type'])){
			...
			$title = "$businessType in Davao City | Davao Region Business Listings Offering Services - Davao Webgate";
	...
	$businessObject = Business::find_by_businessType($business->businessType);
	 ...
	 foreach($businessObject as $object => $businessDetails){
					...
					echo"<div class =\"col col-lg-9 col-md-9 col-sm-9 col-xs-9\">";
						...
						echo "<p><span style = \"color: #999; font-weight: bold;\">Posted in: &nbsp;&nbsp;&nbsp;</span><span style = \"color: #999;\">$businessDetails->businessCategory &nbsp;|&nbsp; $businessDetails->businessType</span></p>";
						echo "</div>";							
						echo"</div>";
						echo "&nbsp;";
						echo "<hr />";
		...
		$message = "Sorry, there is still no business listed in <b>Services - ".$business->businessType." </b>category.";
...
<?php include("_/components/includes/footer_services.php");?>
<?php ob_end_flush();?>