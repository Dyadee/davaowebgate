       ...
       <script type="text/javascript">
      		$("document").ready(function(){
      			<?php if(isset($searchCategory)){
				       	if($searchCategory == "Products"){echo "var tab_active = 0;";}
						else if($searchCategory == "Services"){echo "var tab_active = 1;";}
						else if($searchCategory == "Marketplace"){echo "var tab_active = 2;";}
						else {echo "var tab_active= 0;";}
		       		}else {echo "var tab_active = 0;";}
		       ?>
