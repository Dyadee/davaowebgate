...
<h4>Share us:</h4>
     ...
     <div class="footerCopyright">
      ...
      <script type="text/javascript" src="_/js/myImageRequest.js"></script>
      <script type="text/javascript" src="_/js/myImageRequest_not_logged.js"></script>
      <script type="text/javascript" src="_/js/comment.js"></script>
  </body>
</html>