	...
	<div class = "col col-lg-6 col-md-6 col-sm-12 col-xs-12">
		...
		<h3 class="panel-title" >Comments</h3>
		  ...
		  <div id="chatContainer" class="panel-body">
		   	...
		   	<div id = "comments">Loading Comments for <?php $itemID = $_GET['itemID']; echo "itemID: $itemID<br />";?></div>
		  </div><!--panel body-->
	...
	<div class = "col col-lg-3  col-md-3 col-sm-6 col-xs-6">
		<div class="panel panel-info">
			...
			<div class="panel-body similarANDlatest" style = "height: 552px;">
						...
						if(isset($_GET['category']) && isset($_GET['itemID'])){							
...
<h4>Share us:</h4>
     ...
     <div class="footerCopyright">
      ...
      <?php echo "<script type=\"text/javascript\">"; ?>
			...
			<?php $itemID = $_GET['itemID']; echo "var itemID = ".$itemID.';';?>
